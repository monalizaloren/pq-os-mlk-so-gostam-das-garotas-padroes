...
export default class TransactionScreen extends Component {
  ...
  getStudentDetails = studentId => {
      ...
      .then(snapshot => {
          snapshot.docs.map(doc => {
              this.setState({
                  student_name: doc.data().student_details.student_name
              });
          });
      });
  };

  /*A função getBookDetails recebe um bookId como parâmetro, que é usado para buscar informações do
livro na coleção books do banco de dados. Quando o livro é encontrado, a função atualiza o estado do 
componente com o nome do livro correspondente. A função usa o método where para filtrar a busca pelo 
book_id especificado e depois chama o método get() para obter um snapshot (instantâneo) dos documentos 
correspondentes. Em seguida, a função usa o método map para iterar sobre cada documento e atualiza o 
estado do componente com o nome do livro. */
/* Faça o mesmo com a função *getStudentDetails*/
///???
